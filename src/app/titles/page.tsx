...
const titleEntries = [
  {
    title: "Demon Dweller",
    count: "+100%",
    summary: "New Crystal Defense title with the highest raw damage line currently tracked on the wiki, confirmed at +100% Damage.",
    href: "/entries/demon-dweller",
    ...
    <div className="min-h-screen flex flex-col items-center justify-start pb-16 md:pb-24 border-l-2 md:border-l-4 border-r-2 md:border-r-4 border-[var(--accent-red)] mx-auto max-w-[1920px] shadow-[inset_0_0_40px_rgba(255,30,56,0.1)] md:shadow-[inset_0_0_80px_rgba(255,30,56,0.15)] relative font-sans bg-slate-950">
      ...
      <main className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10 block">
        ...
        <section className="mb-16">
          <div className="panel-action clip-diagonal p-8 sm:p-12 relative overflow-hidden bg-gradient-to-br from-black to-[var(--bg-panel)] border-b-4 border-b-[var(--accent-gold)]/50">
            <div className="relative z-10">
              ...
              <p className="text-xl text-gray-300 max-w-3xl leading-relaxed border-l-4 border-[var(--accent-gold)] pl-6 bg-black/30 py-4">
                Damage, farming, and event titles with unlock routes and loadout uses.
              </p>
              ...
              <div className="flex gap-6 mt-10">
                ...
                <div className="flex flex-col border-r border-white/10 pr-8">
                  ...
                  <span className="text-2xl text-white font-black italic underline decoration-[var(--accent-gold)]">Demon Dweller</span>
                </div>
              ...
              <Link key={i} href={entry.href} className="group panel-action clip-diagonal !p-0 flex flex-col relative overflow-hidden bg-gradient-to-b from-black/80 to-[var(--bg-panel)] hover:border-[var(--accent-gold)] transition-all">
                <div className="p-8 sm:p-10 relative z-10 h-full flex flex-col">
                  <div className="flex justify-between items-start mb-6">
                    <div className="flex flex-col">
                      <span className="text-[10px] text-[var(--accent-gold)] font-black tracking-[0.2em] uppercase">Titles</span>
                      <span className="text-[10px] text-gray-500 font-bold uppercase mt-1 italic">{entry.count}</span>
                    </div>
                    <div className="p-3 bg-white/5 rounded-lg border border-white/10 group-hover:border-[var(--accent-gold)] group-hover:bg-[var(--accent-gold)]/10 transition-all">
                      {entry.icon}
                    </div>
                  </div>
        ...
        <section className="mb-12">
          <div className="panel-action clip-diagonal p-8 sm:p-10 relative overflow-hidden group border-t-4 border-t-[var(--accent-gold)]">
            <div className="flex flex-col md:flex-row gap-12 items-center">
              <div className="flex-1">
                ...
                <p className="text-gray-400 text-sm leading-relaxed mb-8 border-l-2 border-[var(--accent-gold)] pl-6 italic">
                  How the Titles section is checked: We maintain accuracy by cross-referencing with official Discord channels and in-game tests.
                </p>
              </div>
              <div className="flex-1 w-full">
                <ul className="grid grid-cols-1 gap-4">
                  {[
                    ...
                    "Report outdated titles via Discord for quick rechecking."
                  ].map((text, i) => (
                  ...
                  <li className="mt-2 text-right">
                    <Link href="/contact" className="text-[var(--accent-gold)] font-black uppercase text-[10px] tracking-widest inline-flex items-center gap-2 hover:translate-x-2 transition-transform">
