...
export const metadata: Metadata = {
  title: "Sailor Island | Sailor Piece Wiki",
  description: "Main early-to-mid utility hub with fruit dealers, reroll NPCs, ascension access, boss rush entry, and several repeat-visit trainers.",
};

const metaItems = [
  {
    "label": "Best use",
    "value": "Utility hub and repeat-visit progression island"
  },
  {
    "label": "Fruit NPCs",
    "value": "Coin Fruit Dealer and Gems Fruit Dealer"
  },
  {
    "label": "Core utility NPCs",
    "value": "Ascensions NPC, Merchant NPC, Storage Keeper, Stats Master, Trait Master, Stat Reroll NPC"
  }
];
...
const relatedPages = [
  {
    "href": "/entries/fruit-dealers/index",
    "title": "Fruit Dealers on Sailor Island",
    "summary": "Where to find the fruit dealers, what each roll costs, and how players reach them."
  },
  {
    "href": "/entries/powers-overview/index",
    "title": "All Powers / Fruits",
    "summary": "Current list of every fruit in Sailor Piece and the shared dealer route used to obtain them."
  },
  {
    "href": "/entries/stat-reroll-npc/index",
    "title": "Stat Reroll NPC",
    "summary": "Sailor Island gem-based stat reroll station for Damage, Defense, Cooldown Reduction, Crit, Damage Reduction, and Luck lines, with current visible grade values and pity notes."
  },
  {
  ...
  {
    "href": "/entries/npc-locations/index",
    "title": "NPC Locations",
    "summary": "Island-by-island NPC hub for trainers, sellers, masters, dealers, and summoners, plus what each NPC is used for."
  },
  {
    ...
    <div className="min-h-screen flex flex-col items-center justify-start pb-16 md:pb-24 border-l-2 md:border-l-4 border-r-2 md:border-r-4 border-[var(--accent-red)] mx-auto max-w-[1920px] shadow-[inset_0_0_40px_rgba(255,30,56,0.1)] md:shadow-[inset_0_0_80px_rgba(255,30,56,0.15)] relative font-sans bg-slate-950">
      ...
      <main className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10 block">
        ...
        <div className="text-sm text-gray-400 mb-6 font-mono opacity-80">
          ...
          <span className="mx-2">/</span>
          <span className="text-gray-300">Sailor Island</span>
        </div>
        ...
        <div className="mb-12 flex flex-col md:flex-row gap-8 items-start">
          <div className="flex-1">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl leading-relaxed border-l-4 border-[var(--accent-red)] pl-4 backdrop-blur-sm bg-black/20 py-2">
              Main early-to-mid utility hub with fruit dealers, reroll NPCs, ascension access, boss rush entry, and several repeat-visit trainers.
            </p>
