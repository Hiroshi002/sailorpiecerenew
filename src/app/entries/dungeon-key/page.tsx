    ...
    <div className="min-h-screen flex flex-col items-center justify-start pb-16 md:pb-24 border-l-2 md:border-l-4 border-r-2 md:border-r-4 border-[var(--accent-red)] mx-auto max-w-[1920px] shadow-[inset_0_0_40px_rgba(255,30,56,0.1)] md:shadow-[inset_0_0_80px_rgba(255,30,56,0.15)] relative font-sans bg-slate-950">
      ...
      <main className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
        ...
        <div className="text-sm text-gray-400 mb-6 font-mono opacity-80">
          ...
          <span className="text-gray-300">Dungeon Key</span>
        </div>
        ...
        <div className="mb-12">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl leading-relaxed border-l-4 border-[var(--accent-red)] pl-4 backdrop-blur-sm bg-black/20 py-2">
            How to get Dungeon Key in Sailor Piece, the best Dungeon Key farms from bosses, chests, and enemies, and what Dungeon Keys are used for.
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div className="bg-white/5 backdrop-blur-sm rounded-xl p-3 border border-white/10">
                    ...
                    <div className="text-sm font-semibold text-white">Enter dungeons</div>
                  </div>

                  <div className="bg-white/5 backdrop-blur-sm rounded-xl p-3 border border-white/10">
                    <div className="text-xs text-gray-400 mb-1">Best tracked boss</div>
                    <div className="text-sm font-semibold text-white">Aizen at 30%</div>
                  </div>

                  <div className="bg-white/5 backdrop-blur-sm rounded-xl p-3 border border-white/10">
                    <div className="text-xs text-gray-400 mb-1">Best published enemy</div>
                    <div className="text-sm font-semibold text-white">Fast Ninja at 0.95%</div>
                  </div>

                  <div className="bg-white/5 backdrop-blur-sm rounded-xl p-3 border border-white/10">
                    <div className="text-xs text-gray-400 mb-1">Chest shortcut</div>
                    <div className="text-sm font-semibold text-white">Legendary 25%, Mythical 60%, Secret 100%</div>
                  </div>
          </div>
        </div>
          ...
          <div className="mb-8 relative z-10">
            ...
            <ul className="space-y-6">
                ...
                <li className="flex items-start gap-4 text-gray-300 leading-relaxed text-lg">
                  ...
                  <span>Dungeon Key is the entry item consumed for dungeon runs after you unlock dungeons.</span>
                </li>

                <li className="flex items-start gap-4 text-gray-300 leading-relaxed text-lg">
                  <span className="text-blue-400 mt-1">•</span>
                  <span>The current Dungeons page highlights Aizen at 30% as one of the best tracked boss routes, with Sukuna, Jinwoo, and Ichigo at 20%, Gojo and Qin Shi at 15%, and Saber at 10%.</span>
                </li>

                <li className="flex items-start gap-4 text-gray-300 leading-relaxed text-lg">
                  <span className="text-blue-400 mt-1">•</span>
                  <span>On the normal-enemy sheet, Fast Ninja currently leads Dungeon Key at 0.95%, with Strong Bandit at 0.9% and Delinquent plus Strong Fighter at 0.88%.</span>
                </li>
            </ul>
          </div>
        </div>
