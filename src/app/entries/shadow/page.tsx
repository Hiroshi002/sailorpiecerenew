...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: `How to Get Shadow in Sailor Piece | ${siteConfig.name}`,
    description: "Shadow guide for Sailor Piece with obtainment steps, NPC location, materials, questline, mastery, and evolution path notes.",
    openGraph: {
      title: `How to Get Shadow in Sailor Piece | ${siteConfig.name}`,
      description: "Shadow guide for Sailor Piece with obtainment steps, NPC location, materials, questline, mastery, and evolution path notes.",
      url: `${siteConfig.url}`,
...
const metaItems = [
  ...
  {
    "label": "Cost",
    "value": "10,000,000 Money and 15,000 Gems"
  },
  {
    "label": "Moves",
    "value": "M1, Z, X, C, V, F"
...
const moveset = [
  ...
  {
    "key": "Z",
    "description": "Published move slot for the first active Shadow skill.",
    "videoSrc": "",
    "poster": ""
  },
  {
    "key": "X",
    "description": "Published move slot for the second active Shadow skill.",
    "videoSrc": "",
    "poster": ""
  },
  {
    "key": "C",
    "description": "Published move slot for the third active Shadow skill.",
    "videoSrc": "",
    "poster": ""
  },
  {
    "key": "V",
    "description": "Published move slot for the fourth active Shadow skill.",
    "videoSrc": "",
    "poster": ""
  },
  {
    "key": "F",
    "description": "Unlocked after finishing the Shadow mastery route.",
    "videoSrc": "",
    "poster": ""
  }
];
        ...
        <div className="mb-12 flex flex-col md:flex-row gap-8 items-start">
          <div className="flex-1">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl leading-relaxed border-l-4 border-[var(--accent-red)] pl-4 backdrop-blur-sm bg-black/20 py-2">
              Dungeon Island sword, also searched as CID V1, that acts as the direct base weapon for Atomic.
            </p>
