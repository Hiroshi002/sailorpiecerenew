    ...
    <div className="min-h-screen flex flex-col items-center justify-start pb-16 md:pb-24 border-l-2 md:border-l-4 border-r-2 md:border-r-4 border-[var(--accent-red)] mx-auto max-w-[1920px] shadow-[inset_0_0_40px_rgba(255,30,56,0.1)] md:shadow-[inset_0_0_80px_rgba(255,30,56,0.15)] relative font-sans bg-slate-950">
      ...
      <main className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
        ...
        <div className="text-sm text-gray-400 mb-6 font-mono opacity-80">
          ...
          <span className="text-gray-300">Upper Seal</span>
        </div>
        ...
        <div className="mb-12">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl leading-relaxed border-l-4 border-[var(--accent-red)] pl-4 backdrop-blur-sm bg-black/20 py-2">
            How to get Upper Seal in Sailor Piece, the current Upper Seal drop chances, and why this material is one of the main Moon Slayer bottlenecks.
          </p>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            
                  <div className="bg-white/5 backdrop-blur-sm rounded-xl p-3 border border-white/10">
                    <div className="text-xs text-gray-400 mb-1">Main route</div>
                    <div className="text-sm font-semibold text-white">Moon Slayer</div>
                  </div>

                  <div className="bg-white/5 backdrop-blur-sm rounded-xl p-3 border border-white/10">
                    <div className="text-xs text-gray-400 mb-1">Best published enemy</div>
                    <div className="text-sm font-semibold text-white">Fast Ninja at 0.2925%</div>
                  </div>

                  <div className="bg-white/5 backdrop-blur-sm rounded-xl p-3 border border-white/10">
                    <div className="text-xs text-gray-400 mb-1">Base style need</div>
                    <div className="text-sm font-semibold text-white">25 Upper Seal</div>
                  </div>

                  <div className="bg-white/5 backdrop-blur-sm rounded-xl p-3 border border-white/10">
                    <div className="text-xs text-gray-400 mb-1">F move need</div>
                    <div className="text-sm font-semibold text-white">85 Upper Seal</div>
                  </div>
          </div>
        </div>
          ...
          <div className="mb-8 relative z-10">
            ...
            <ul className="space-y-6">
                ...
                <li className="flex items-start gap-4 text-gray-300 leading-relaxed text-lg">
                  ...
                  <span>Upper Seal is currently tracked as a late Sea 2 normal-enemy material rather than a boss-only drop.</span>
                </li>

                <li className="flex items-start gap-4 text-gray-300 leading-relaxed text-lg">
                  <span className="text-blue-400 mt-1">•</span>
                  <span>The strongest published Upper Seal line on the current site is Fast Ninja at 0.2925%, with Strong Bandit next at 0.2825% and Delinquent plus Strong Fighter at 0.255%.</span>
                </li>

                <li className="flex items-start gap-4 text-gray-300 leading-relaxed text-lg">
                  <span className="text-blue-400 mt-1">•</span>
                  <span>Moon Slayer currently asks for 25 Upper Seal for the base style and 85 Upper Seal for the F move mastery route.</span>
                </li>
            </ul>
          </div>
        </div>
