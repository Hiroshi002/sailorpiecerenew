...
export const metadata: Metadata = {
  title: "How to Get Frost Relic in Sailor Piece | Uses, Farm Notes, Ice Queen Route",
  description: "How to get Frost Relic in Sailor Piece, what Frost Relic is used for, and how it fits into the Ice Queen weapon, summon, and F move route.",
};
...
const metaItems = [
  ...
  {
    "label": "Base unlock need",
    "value": "25 Frost Relic"
  },
  {
    "label": "F move mastery need",
    "value": "85 Frost Relic"
  },
  {
    "label": "Summon cost band",
    "value": "1 to 4 Frost Relic depending on difficulty"
  }
];
    ...
    <div className="min-h-screen flex flex-col items-center justify-start pb-16 md:pb-24 border-l-2 md:border-l-4 border-r-2 md:border-r-4 border-[var(--accent-red)] mx-auto max-w-[1920px] shadow-[inset_0_0_40px_rgba(255,30,56,0.1)] md:shadow-[inset_0_0_80px_rgba(255,30,56,0.15)] relative font-sans bg-slate-950">
      ...
      <main className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10 block">
        ...
        <div className="text-sm text-gray-400 mb-6 font-mono opacity-80">
          ...
          <span className="mx-2">/</span>
          <span className="text-gray-300">Frost Relic</span>
        </div>
        ...
        <div className="mb-12 flex flex-col md:flex-row gap-8 items-start">
          <div className="flex-1">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl leading-relaxed border-l-4 border-[var(--accent-red)] pl-4 backdrop-blur-sm bg-black/20 py-2">
              How to get Frost Relic in Sailor Piece, what Frost Relic is used for, and why it matters across the full Ice Queen weapon route instead of only one boss screen.
            </p>
