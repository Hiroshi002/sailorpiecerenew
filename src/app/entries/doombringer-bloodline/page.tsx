...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: `Doombringer Bloodline | ${siteConfig.name}`,
    description: "Doombringer Bloodline Sailor Piece page with Legendary rarity, stats, passive, and current Sea 2 update notes.",
    openGraph: {
      title: `Doombringer Bloodline | ${siteConfig.name}`,
      description: "Doombringer Bloodline Sailor Piece page with Legendary rarity, stats, passive, and current Sea 2 update notes.",
      url: `${siteConfig.url}`,
...
const metaItems = [
  ...
  { label: "Luck Multi", value: "+12%" },
  { label: "Lifesteal", value: "+2%" },
  { label: "Sword Damage Multi", value: "+12%" },
  { label: "Max HP", value: "+40%" },
];

const facts = [
  "Doombringer is one of the 2 new Legendary bloodlines from the current update.",
  "The tooltip shows +32% Damage, +12% Luck Multi, +2% Lifesteal, +12% Sword Damage Multi, and +40% Max HP.",
  "The passive gives a 20% chance on every skill used to gain a +20% damage buff for 8 seconds.",
  "Doombringer is currently the newest sword burst bloodline capture.",
];
...
const stats = [
  ...
  { label: "Sword Damage Multi", value: "+12%" },
  { label: "Max HP", value: "+40%" },
  { label: "Passive", value: "20% chance on every skill used: +20% Damage for 8 seconds" },
];

const relatedPages = [
  { href: "/entries/bloodlines-system", title: "Bloodlines", summary: "Main Bloodlines overview with Doombringer ranked among the newest Legendary lines." },
  { href: "/entries/best-builds-overview", title: "Best Builds", summary: "Endgame build page now considering Doombringer for sword burst routes." },
];

export default function DoombringerBloodline() {
  return (
        ...
        <div className="panel-action clip-diagonal p-8 sm:p-12 lg:p-20 relative overflow-hidden flex flex-col items-center md:items-start text-center md:text-left">
          ...
          <div className="relative z-10 w-full">
            ...
            <h1 className="text-4xl sm:text-6xl lg:text-8xl leading-[0.9] text-white text-kinetic text-shadow-red mb-6 font-black uppercase italic tracking-tighter">
              Doombringer <span className="text-[var(--accent-gold)] text-shadow-gold block md:inline">Bloodline</span>
            </h1>
            <p className="text-gray-300 w-full max-w-2xl text-base sm:text-xl font-medium leading-relaxed mb-10 border-l-4 border-[var(--accent-red)] pl-6 italic bg-black/20 py-4">
              New Legendary sword burst bloodline with damage, luck, lifesteal, sword scaling, max HP, and a skill-use damage buff passive.
            </p>
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="bg-black/60 p-6 border border-white/5 clip-button">
                   ...
                   <p className="text-white text-xs font-medium leading-relaxed">
                      Legendary roll odds and pity behavior are currently being tracked for the latest Sea 2 patch.
                   </p>
                </div>
             </div>
          </div>
