...
export const metadata: Metadata = {
  title: "How to Get Guild Key in Sailor Piece | Drop Chance, Best Farm, Uses",
  description: "How to get Guild Key in Sailor Piece, including the Guild Key drop chance, best Guild Key farm, Sea 2 NPC and boss sources, and what Guild Key is used for.",
};

const metaItems = [
  {
    "label": "Main use",
    "value": "Create a guild"
  },
  {
    "label": "Create requirement",
    "value": "Level 10,000 and 1 Guild Key"
  },
  {
    "label": "Best boss rate",
    "value": "0.011% on Sea Serpent and Kraken"
  },
  {
    "label": "Best normal enemy",
    "value": "Fast Ninja at 0.00026342%"
  }
];
...
const relatedPages = [
  {
    ...
    "title": "Guilds",
    "summary": "Sea 2 Guilds system page with the confirmed create-guild requirements, the now-tracked Guild Key drop rates and Guild Key drop chance routes from current Sea 2 mobs and bosses, and the current guild-upgrade board showing member capacity, damage, crit damage, crit chance, HP, and luck level caps plus per-level gains."
  },
  {
  ...
  {
    "href": "/entries/dragon-goddess/index",
    "title": "Dragon Goddess",
    "summary": "Sea 2 weapon page now anchored to the Sea Serpent and Kraken farming route, with the current drop rates and Sea 2-only spawn setup."
  }
];
    ...
    <div className="min-h-screen flex flex-col items-center justify-start pb-16 md:pb-24 border-l-2 md:border-l-4 border-r-2 md:border-r-4 border-[var(--accent-red)] mx-auto max-w-[1920px] shadow-[inset_0_0_40px_rgba(255,30,56,0.1)] md:shadow-[inset_0_0_80px_rgba(255,30,56,0.15)] relative font-sans bg-slate-950">
      ...
      <main className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10 block">
        ...
        <div className="text-sm text-gray-400 mb-6 font-mono opacity-80">
          ...
          <span className="mx-2">/</span>
          <span className="text-gray-300">Guild Key</span>
        </div>
        ...
        <div className="mb-12 flex flex-col md:flex-row gap-8 items-start">
          <div className="flex-1">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl leading-relaxed border-l-4 border-[var(--accent-red)] pl-4 backdrop-blur-sm bg-black/20 py-2">
              How to get Guild Key in Sailor Piece, what it is used for, and the current Guild Key drop chance routes across Sea 2 normal enemies and bosses.
            </p>
