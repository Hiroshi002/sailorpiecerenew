...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: `How to Get Manipulator Sword (Aizen Sword) in Sailor Piece | ${siteConfig.name}`,
    description: "Manipulator Sword (Aizen Sword) guide for Sailor Piece with obtainment steps, NPC location, materials, questline, mastery, and evolution path notes.",
    openGraph: {
      title: `How to Get Manipulator Sword (Aizen Sword) in Sailor Piece | ${siteConfig.name}`,
      description: "Manipulator Sword (Aizen Sword) guide for Sailor Piece with obtainment steps, NPC location, materials, questline, mastery, and evolution path notes.",
      url: `${siteConfig.url}`,
...
const metaItems = [
  {
    "label": "NPC",
    "value": "Manipulator Trainer"
  },
  {
    "label": "Island",
    "value": "Hollow Island (Hueco Mundo)"
  },
  {
    "label": "Cost",
    "value": "6,000,000 Money and 10,000 Gems"
  },
  {
    "label": "Moves",
    "value": "M1, Z, X, C, V"
...
const moveset = [
  {
    "key": "M1",
    "description": "Continuous slashes with purple sparks.",
    "videoSrc": "",
    "poster": ""
  },
  {
    "key": "Z",
    "description": "Push the sword forward and create a yellow power blow.",
    "videoSrc": "",
    "poster": ""
  },
  {
    "key": "X",
    "description": "Chain sword slashes and finish with a cross attack.",
    "videoSrc": "",
    "poster": ""
  },
  {
    "key": "C",
    "description": "Create a large area attack in a circle around you.",
    "videoSrc": "",
    "poster": ""
  },
  {
    "key": "V",
    "description": "Form a long rectangular domain and damage enemies inside it.",
    "videoSrc": "",
    "poster": ""
  }
];
    ...
    <div className="min-h-screen flex flex-col items-center justify-start pb-16 md:pb-24 border-l-2 md:border-l-4 border-r-2 md:border-r-4 border-[var(--accent-red)] mx-auto max-w-[1920px] shadow-[inset_0_0_40px_rgba(255,30,56,0.1)] md:shadow-[inset_0_0_80px_rgba(255,30,56,0.15)] relative font-sans bg-slate-950">
      ...
      <main className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10 block">
        ...
        <div className="text-sm text-gray-400 mb-6 font-mono opacity-80">
          ...
          <span className="mx-2">/</span>
          <span className="text-gray-300">Manipulator Sword (Aizen Sword)</span>
        </div>
        ...
        <div className="mb-12 flex flex-col md:flex-row gap-8 items-start">
          <div className="flex-1">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl leading-relaxed border-l-4 border-[var(--accent-red)] pl-4 backdrop-blur-sm bg-black/20 py-2">
              Late-game Hollow Island (Hueco Mundo) sword that starts with a full trainer questline and then asks for boss materials and gems.
            </p>
