...
export const metadata: Metadata = {
  title: "Sailor Piece NPC Drop Chances | Guild Key, Dominion Brand, Relic Parts",
  description: "Normal enemy drop charts for Sailor Piece with NPC drop chances for Guild Key, Dominion Brand, Relic Parts, rerolls, chests, keys, crates, and other rare materials.",
};

const metaItems = [
  {
    "label": "Tracked enemies",
    "value": "18 normal-enemy rows"
  },
  {
    "label": "Best chest farm",
    "value": "Fast Ninja"
  },
  {
    "label": "Best reroll band",
    "value": "Curse and the late Sea 2 mobs"
  },
  {
    "label": "Best key overlap",
    "value": "Fast Ninja and Strong Bandit"
  }
];
    ...
    <div className="min-h-screen flex flex-col items-center justify-start pb-16 md:pb-24 border-l-2 md:border-l-4 border-r-2 md:border-r-4 border-[var(--accent-red)] mx-auto max-w-[1920px] shadow-[inset_0_0_40px_rgba(255,30,56,0.1)] md:shadow-[inset_0_0_80px_rgba(255,30,56,0.15)] relative font-sans bg-slate-950">
      ...
      <main className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10 block">
        ...
        <div className="text-sm text-gray-400 mb-6 font-mono opacity-80">
          ...
          <span className="mx-2">/</span>
          <span className="text-gray-300">Normal Enemy Drop Charts</span>
        </div>
        ...
        <div className="mb-12 flex flex-col md:flex-row gap-8 items-start">
          <div className="flex-1">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl leading-relaxed border-l-4 border-[var(--accent-red)] pl-4 backdrop-blur-sm bg-black/20 py-2">
              Published normal-enemy drop tables for rerolls, chests, keys, and newer Sea 2 route materials, including Guild Key drop chance, Dominion Brand drop chance, and Relic Part drop chances, organized into readable charts instead of one giant screenshot dump.
            </p>
