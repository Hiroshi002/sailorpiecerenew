...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: `How to Get Shadow Monarch in Sailor Piece | ${siteConfig.name}`,
    description: "Shadow Monarch guide for Sailor Piece with obtainment steps, NPC location, materials, questline, mastery, and evolution path notes.",
    openGraph: {
      title: `How to Get Shadow Monarch in Sailor Piece | ${siteConfig.name}`,
      description: "Shadow Monarch guide for Sailor Piece with obtainment steps, NPC location, materials, questline, mastery, and evolution path notes.",
      url: `${siteConfig.url}`,
...
const metaItems = [
  {
    "label": "NPC",
    "value": "Shadow Monarch NPC"
  },
  {
    "label": "Island",
    "value": "Dungeon Island"
  },
  {
    "label": "Base weapon",
    "value": "Jinwoo"
...
const moveset = [
  {
    "key": "M1",
    "description": "Basic sword combo.",
    "videoSrc": "",
    "poster": ""
  },
  {
    "key": "Z",
    "description": "Use a medium-range slice that ends with a dash.",
    "videoSrc": "",
    "poster": ""
  },
  {
    "key": "X",
    "description": "Summon a minion or statue that deals continuous fire damage around it.",
    "videoSrc": "",
    "poster": ""
  },
  {
    "key": "C",
    "description": "Use a short-range area attack around your character.",
    "videoSrc": "",
    "poster": ""
  },
  {
    "key": "V",
    "description": "Perform very fast slashes in a large area.",
    "videoSrc": "",
    "poster": ""
  },
  {
    "key": "F",
    "description": "Release repeated purple slashes after completing mastery.",
    "videoSrc": "",
    "poster": ""
  }
];
    ...
    <div className="min-h-screen flex flex-col items-center justify-start pb-16 md:pb-24 border-l-2 md:border-l-4 border-r-2 md:border-r-4 border-[var(--accent-red)] mx-auto max-w-[1920px] shadow-[inset_0_0_40px_rgba(255,30,56,0.1)] md:shadow-[inset_0_0_80px_rgba(255,30,56,0.15)] relative font-sans bg-slate-950">
      ...
      <main className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10 block">
        ...
        <div className="text-sm text-gray-400 mb-6 font-mono opacity-80">
          ...
          <span className="mx-2">/</span>
          <span className="text-gray-300">Shadow Monarch</span>
        </div>
        ...
        <div className="mb-12 flex flex-col md:flex-row gap-8 items-start">
          <div className="flex-1">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl leading-relaxed border-l-4 border-[var(--accent-red)] pl-4 backdrop-blur-sm bg-black/20 py-2">
              Dungeon Island upgrade sword that consumes Jinwoo and a full set of Shadow Monarch boss drops.
            </p>
