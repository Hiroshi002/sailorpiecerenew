...
export const metadata: Metadata = {
  title: "Dev Products | Sailor Piece Wiki",
  description: "Current in-game Sailor Piece dev products, confirmed Robux prices, bundle notes, and CCR anchor products for traders.",
};

const metaItems = [
  {
    "label": "Confirmed standard products",
    "value": "64"
  },
  {
    "label": "Confirmed bundles",
    "value": "8"
  },
  {
    "label": "Cheapest confirmed products",
    "value": "10 Passive Shard and 10 Clan Reroll at 49 Robux"
  },
  {
    "label": "Best CCR anchor",
    "value": "Clan Reroll packs"
  }
];
...
const relatedPages = [
  {
    "href": "/entries/trade-values-overview/index",
    "title": "Trade Values",
    "summary": "Official Sailor Piece trading links, CCR guidance, and a credited snapshot of gamepass, ascension, material, chest, and boss-drop values before handing off to the full endorsed value list."
  },
  {
    "href": "/entries/trade-values-overview/index",
    "title": "Trade Values",
    "summary": "Open the official value hub and CCR guide"
  },
  {
    "href": "https://sailor-piece.vaultedvaluesx.com/value-list",
    "title": "Official Value List",
    "summary": "Check the live value of tradable store products"
  },
  {
    "href": "https://sailor-piece.vaultedvaluesx.com/trade-calculator",
    "title": "Trade Calculator",
    "summary": "Compare store items against current offers"
  }
];
    ...
    <div className="min-h-screen flex flex-col items-center justify-start pb-16 md:pb-24 border-l-2 md:border-l-4 border-r-2 md:border-r-4 border-[var(--accent-red)] mx-auto max-w-[1920px] shadow-[inset_0_0_40px_rgba(255,30,56,0.1)] md:shadow-[inset_0_0_80px_rgba(255,30,56,0.15)] relative font-sans bg-slate-950">
      ...
      <main className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10 block">
        ...
        <div className="text-sm text-gray-400 mb-6 font-mono opacity-80">
          ...
          <span className="mx-2">/</span>
          <span className="text-gray-300">Dev Products</span>
        </div>
        ...
        <div className="mb-12 flex flex-col md:flex-row gap-8 items-start">
          <div className="flex-1">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl leading-relaxed border-l-4 border-[var(--accent-red)] pl-4 backdrop-blur-sm bg-black/20 py-2">
              Current in-game Sailor Piece dev products, confirmed Robux prices, bundle notes, and CCR anchor products for traders.
            </p>
