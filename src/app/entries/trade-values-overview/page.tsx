...
const metaItems = [
  {
    "label": "Official value source",
    "value": "Vaulted ValuesX"
  },
  {
    "label": "Trading currency",
    "value": "CCR or Clan Reroll"
  },
  {
    "label": "Preview shown here",
    "value": "Gamepasses, ascensions, and popular trade items"
  },
  {
    "label": "Full live list",
    "value": "Vaulted ValuesX value list"
  },
  {
...
const relatedPages = [
  ...
  },
  {
    ...
    "summary": "Live Sailor Piece values from Vaulted ValuesX"
  },
  {
    "href": "https://sailor-piece.vaultedvaluesx.com/trade-calculator",
    "title": "Trade Calculator",
    "summary": "Compare both sides of a trade"
  },
  {
    "href": "https://sailor-piece.vaultedvaluesx.com/trade-ads",
    "title": "Trade Ads",
    "summary": "Browse and post trading offers"
  }
];
        ...
        <div className="mb-12 flex flex-col md:flex-row gap-8 items-start">
          <div className="flex-1">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl leading-relaxed border-l-4 border-[var(--accent-red)] pl-4 backdrop-blur-sm bg-black/20 py-2">
              Official Sailor Piece trading links, CCR guidance, and a credited snapshot of gamepass, ascension, material, chest, and boss-drop values before handing off to the full endorsed value list.
            </p>
