...
export const metadata: Metadata = {
  title: "How to Get Relic Parts in Sailor Piece | Relic Part Drop Chances, Routes, Recipes",
  description: "How to get Relic Parts in Sailor Piece, including Relic Part #1 to #8 drop chances, NPC routes, and the relic recipes they are used for.",
};

const metaItems = [
  {
    "label": "Part count",
    "value": "8 tracked relic parts"
  },
  {
    "label": "Current NPC spread",
    "value": "Delinquent to Fast Ninja"
  },
  {
    "label": "Highest part rate",
    "value": "Relic Part #1 at 0.015%"
  },
  {
    "label": "Main NPC",
    "value": "Relic Crafter on Bizarre Island"
  }
];
    ...
    <div className="min-h-screen flex flex-col items-center justify-start pb-16 md:pb-24 border-l-2 md:border-l-4 border-r-2 md:border-r-4 border-[var(--accent-red)] mx-auto max-w-[1920px] shadow-[inset_0_0_40px_rgba(255,30,56,0.1)] md:shadow-[inset_0_0_80px_rgba(255,30,56,0.15)] relative font-sans bg-slate-950">
      ...
      <main className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10 block">
        ...
        <div className="text-sm text-gray-400 mb-6 font-mono opacity-80">
          ...
          <span className="mx-2">/</span>
          <span className="text-gray-300">Relic Parts</span>
        </div>
        ...
        <div className="mb-12 flex flex-col md:flex-row gap-8 items-start">
          <div className="flex-1">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl leading-relaxed border-l-4 border-[var(--accent-red)] pl-4 backdrop-blur-sm bg-black/20 py-2">
              How to get Relic Parts in Sailor Piece, including Relic Part #1 to #8 drop chances, where each part drops, and which relic recipes they feed.
            </p>
