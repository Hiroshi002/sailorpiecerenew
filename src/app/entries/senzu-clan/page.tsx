...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: `Senzu Clan | ${siteConfig.name}`,
    description: "Senzu clan Sailor Piece page with Legendary rarity, stats, every-sixth-skill passive, and current update notes.",
    openGraph: {
      title: `Senzu Clan | ${siteConfig.name}`,
      description: "Senzu clan Sailor Piece page with Legendary rarity, stats, every-sixth-skill passive, and current update notes.",
      url: `${siteConfig.url}`,
...
const metaItems = [
  ...
  { label: "Max HP", value: "+55%" },
  { label: "Melee Damage", value: "+15%" },
  { label: "Luck", value: "+12%" },
  { label: "Passive", value: "Every sixth skill has 1.65x damage" },
];

const facts = [
  "Senzu is the new Legendary clan from the current update.",
  "The tooltip shows +45% Damage, +55% Max HP, +15% Melee Damage, and +12% Luck.",
  "The passive says every sixth skill has a 1.65x damage multiplier.",
  "Senzu is currently the newest raw damage and melee burst clan capture.",
];
...
const relatedPages = [
  { href: "/entries/clans-overview", title: "Clans", summary: "Main Clans overview with Senzu in the Legendary clan list." },
  { href: "/entries/best-builds-overview", title: "Best Builds", summary: "Endgame build page now considering Senzu for raw damage and melee burst routes." },
];

export default function SenzuClan() {
  return (
        ...
        <div className="panel-action clip-diagonal p-8 sm:p-12 lg:p-20 relative overflow-hidden flex flex-col items-center md:items-start text-center md:text-left">
          ...
          <div className="relative z-10 w-full">
            <div className="flex flex-wrap items-center justify-center md:justify-start gap-4 mb-8">
              ...
              <div className="px-3 py-1 bg-[var(--accent-red)]/20 border border-[var(--accent-red)]/40 text-[var(--accent-red)] text-[10px] font-black uppercase tracking-widest clip-button">Clans</div>
            ...
            <h1 className="text-4xl sm:text-6xl lg:text-8xl leading-[0.9] text-white text-kinetic text-shadow-red mb-6 font-black uppercase italic tracking-tighter">
              Senzu <span className="text-[var(--accent-gold)] text-shadow-gold block md:inline">Clan</span>
            </h1>
            <p className="text-gray-300 w-full max-w-2xl text-base sm:text-xl font-medium leading-relaxed mb-10 border-l-4 border-[var(--accent-red)] pl-6 italic bg-black/20 py-4">
              New Legendary clan with high raw damage, melee damage, luck, HP, and an every-sixth-skill burst passive.
            </p>
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="bg-black/60 p-6 border border-white/5 clip-button">
                   ...
                   <p className="text-white text-xs font-medium leading-relaxed">
                      Senzu clan roll odds and pity thresholds are currently being verified against the latest Sea 2 clan-roll data.
                   </p>
                </div>
             </div>
          </div>
