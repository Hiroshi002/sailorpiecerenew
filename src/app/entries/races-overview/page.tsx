...
const metaItems = [
  ...
  {
    "label": "Main reroll route",
    "value": "Inventory &gt; Items"
  },
  {
    "label": "Key sword race",
    "value": "Swordblessed for Yamato"
  },
  {
    "label": "Key Aizen race",
    "value": "Shinigami"
  }
];
        ...
        <div className="mb-12 flex flex-col md:flex-row gap-8 items-start">
          <div className="flex-1">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl leading-relaxed border-l-4 border-[var(--accent-red)] pl-4 backdrop-blur-sm bg-black/20 py-2">
              Race rerolls, passive bonuses, and build-defining races used by late-game weapons and specs.
            </p>
