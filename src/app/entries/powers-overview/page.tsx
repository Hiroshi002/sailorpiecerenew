...
const metaItems = [
  {
    "label": "Confirmed fruits",
    "value": "5"
  },
  {
    "label": "Main obtainment",
    "value": "Fruit dealers on Sailor Island"
  },
  {
    "label": "Coin roll",
    "value": "15,000 coins"
...
const relatedPages = [
  ...
  },
  {
    ...
    "title": "Sailor Island",
    "summary": "Main early-to-mid utility hub with fruit dealers, reroll NPCs, ascension access, boss rush entry, and several repeat-visit trainers."
  },
  {
    "href": "/entries/invisible-fruit/index",
    "title": "Invisible Fruit",
    "summary": "Common fruit focused on invisibility, with the highest published roll chance among the current fruit set."
  },
  {
    "href": "/entries/bomb-fruit/index",
    "title": "Bomb Fruit",
    "summary": "Uncommon fruit with a short-cooldown area blast and a high dealer roll rate."
  },
  {
    "href": "/entries/flame-fruit/index",
    "title": "Flame Fruit",
    "summary": "Rare fruit with projectile and close-range area damage, positioned as a solid early upgrade."
  },
  {
    "href": "/entries/quake-fruit/index",
    "title": "Quake Fruit",
    "summary": "Epic fruit built around shockwaves and tsunamis, with a much lower published roll chance than early fruits."
  },
  {
    "href": "/entries/light-fruit/index",
    "title": "Light Fruit",
    "summary": "Legendary fruit with sword-like light attacks, area damage, and flight, currently one of the rarest dealer fruits in the wiki&#39;s tracked dealer pool."
  }
];
    ...
    <div className="min-h-screen flex flex-col items-center justify-start pb-16 md:pb-24 border-l-2 md:border-l-4 border-r-2 md:border-r-4 border-[var(--accent-red)] mx-auto max-w-[1920px] shadow-[inset_0_0_40px_rgba(255,30,56,0.1)] md:shadow-[inset_0_0_80px_rgba(255,30,56,0.15)] relative font-sans bg-slate-950">
      ...
      <main className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10 block">
        ...
        <div className="text-sm text-gray-400 mb-6 font-mono opacity-80">
          ...
          <span className="mx-2">/</span>
          <span className="text-gray-300">All Fruits</span>
        </div>
        ...
        <div className="mb-12 flex flex-col md:flex-row gap-8 items-start">
          <div className="flex-1">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl leading-relaxed border-l-4 border-[var(--accent-red)] pl-4 backdrop-blur-sm bg-black/20 py-2">
              Current list of every fruit in Sailor Piece and the shared dealer route used to obtain them.
            </p>
