...
export const metadata: Metadata = {
  title: "Sailor Piece Melees | Fighting Styles, Quests, F Moves",
  description: "Sailor Piece melees guide with fighting styles, trainers, quests, materials, evolution paths, mastery, and F moves.",
};

const metaItems = [
  {
    "label": "Current styles",
    "value": "17 including Combat"
  },
  {
    "label": "Starter melee",
    "value": "Combat by default"
  },
  {
    "label": "Late-game passive layer",
    "value": "Spec Passives at Judgement Island"
  },
  {
    "label": "Main mid-game style",
    "value": "Gojo"
  }
];
...
const relatedPages = [
  {
    "href": "/entries/what-is-a-melee-style/index",
    "title": "What Is a Fighting Style in Sailor Piece?",
    "summary": "Explains what fighting styles do in Sailor Piece, how they fit into builds, and what each melee page on this wiki is meant to track."
  },
  {
  ...
  {
    "href": "/entries/upper-seal/index",
    "title": "Upper Seal",
    "summary": "How to get Upper Seal in Sailor Piece, the current Upper Seal drop chances, and why this material is one of the main Moon Slayer bottlenecks."
  }
];
    ...
    <div className="min-h-screen flex flex-col items-center justify-start pb-16 md:pb-24 border-l-2 md:border-l-4 border-r-2 md:border-r-4 border-[var(--accent-red)] mx-auto max-w-[1920px] shadow-[inset_0_0_40px_rgba(255,30,56,0.1)] md:shadow-[inset_0_0_80px_rgba(255,30,56,0.15)] relative font-sans bg-slate-950">
      ...
      <main className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10 block">
        ...
        <div className="text-sm text-gray-400 mb-6 font-mono opacity-80">
          ...
          <span className="mx-2">/</span>
          <span className="text-gray-300">Melees and Fighting Styles</span>
        </div>
        ...
        <div className="mb-12 flex flex-col md:flex-row gap-8 items-start">
          <div className="flex-1">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl leading-relaxed border-l-4 border-[var(--accent-red)] pl-4 backdrop-blur-sm bg-black/20 py-2">
              Current melee roster in Sailor Piece and the shared way fighting styles scale into late-game content.
            </p>
