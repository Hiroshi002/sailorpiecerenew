...
export const metadata: Metadata = {
  title: "Clover Outfit | Sailor Piece Crystal Defense Accessory",
  description: "Clover Outfit Sailor Piece page with the Crystal Defense shop route, Punch Island vendor, and current 850 Crystal Coin cost.",
};
...
const metaItems = [
  ...
  {
    "label": "Vendor",
    "value": "Defense Merchant"
  },
  {
    "label": "Cost",
    "value": "850 Crystal Coins"
  },
  {
    "label": "Base stats",
    "value": "120% Defense / 100% Damage / 15% Damage Reduction"
  },
  {
    "label": "E10 stats",
    "value": "170% Defense / 140% Damage / 35% Damage Reduction"
  }
];
    ...
    <div className="min-h-screen flex flex-col items-center justify-start pb-16 md:pb-24 border-l-2 md:border-l-4 border-r-2 md:border-r-4 border-[var(--accent-red)] mx-auto max-w-[1920px] shadow-[inset_0_0_40px_rgba(255,30,56,0.1)] md:shadow-[inset_0_0_80px_rgba(255,30,56,0.15)] relative font-sans bg-slate-950">
      ...
      <main className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10 block">
        ...
        <div className="text-sm text-gray-400 mb-6 font-mono opacity-80">
          ...
          <span className="mx-2">/</span>
          <span className="text-gray-300">Clover Outfit</span>
        </div>
        ...
        <div className="mb-12 flex flex-col md:flex-row gap-8 items-start">
          <div className="flex-1">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl leading-relaxed border-l-4 border-[var(--accent-red)] pl-4 backdrop-blur-sm bg-black/20 py-2">
              New Crystal Defense merchant accessory sold by the Defense Merchant on Punch Island for Crystal Coins, now with the current base stat line and E10 end point confirmed.
            </p>
