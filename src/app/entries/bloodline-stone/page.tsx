    ...
    <div className="min-h-screen flex flex-col items-center justify-start pb-16 md:pb-24 border-l-2 md:border-l-4 border-r-2 md:border-r-4 border-[var(--accent-red)] mx-auto max-w-[1920px] shadow-[inset_0_0_40px_rgba(255,30,56,0.1)] md:shadow-[inset_0_0_80px_rgba(255,30,56,0.15)] relative font-sans bg-slate-950">
      ...
      <main className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
        ...
        <div className="text-sm text-gray-400 mb-6 font-mono opacity-80">
          ...
          <span className="text-gray-300">Bloodline Stone</span>
        </div>
        ...
        <div className="mb-12">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl leading-relaxed border-l-4 border-[var(--accent-red)] pl-4 backdrop-blur-sm bg-black/20 py-2">
            How to get Bloodline Stone in Sailor Piece, the current Bloodline Stone drop chance routes, and why Sea Beasts and late Sea 2 NPCs are the main grind.
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div className="bg-white/5 backdrop-blur-sm rounded-xl p-3 border border-white/10">
                    ...
                    <div className="text-sm font-semibold text-white">Bloodlines</div>
                  </div>

                  <div className="bg-white/5 backdrop-blur-sm rounded-xl p-3 border border-white/10">
                    <div className="text-xs text-gray-400 mb-1">Current source type</div>
                    <div className="text-sm font-semibold text-white">Sea 2 NPCs and Sea Beasts</div>
                  </div>

                  <div className="bg-white/5 backdrop-blur-sm rounded-xl p-3 border border-white/10">
                    <div className="text-xs text-gray-400 mb-1">Best boss route</div>
                    <div className="text-sm font-semibold text-white">Sea Serpent and Kraken at 50%</div>
                  </div>

                  <div className="bg-white/5 backdrop-blur-sm rounded-xl p-3 border border-white/10">
                    <div className="text-xs text-gray-400 mb-1">Best normal enemy</div>
                    <div className="text-sm font-semibold text-white">Fast Ninja at 0.292515%</div>
                  </div>
          </div>
        </div>
          ...
          <div className="mb-8 relative z-10">
            ...
            <ul className="space-y-4">
                ...
                <li className="flex items-start gap-3 text-gray-300">
                  ...
                  <span>Bloodline Stone is the core item used by the Sea 2 Bloodlines system.</span>
                </li>

                <li className="flex items-start gap-3 text-gray-300">
                  <span className="text-blue-400 mt-1">•</span>
                  <span>The current site tracks Bloodline Stone from Delinquent, Strong Fighter, Strong Bandit, Fast Ninja, Sea Serpent, and Kraken.</span>
                </li>

                <li className="flex items-start gap-3 text-gray-300">
                  <span className="text-blue-400 mt-1">•</span>
                  <span>Sea Serpent and Kraken are the strongest current Bloodline Stone routes on the site, with the current FAQ sheet showing 50% with quantity 15.</span>
                </li>
            </ul>
          </div>
        </div>
