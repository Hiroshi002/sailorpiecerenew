...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: `How to Get Escanor in Sailor Piece | ${siteConfig.name}`,
    description: "Escanor guide for Sailor Piece with obtainment steps, NPC location, materials, questline, mastery, and evolution path notes.",
    openGraph: {
      title: `How to Get Escanor in Sailor Piece | ${siteConfig.name}`,
      description: "Escanor guide for Sailor Piece with obtainment steps, NPC location, materials, questline, mastery, and evolution path notes.",
      url: `${siteConfig.url}`,
...
const metaItems = [
  {
    "label": "Main route",
    "value": "Boss Rush on Sailor Island"
  },
  {
    "label": "Drop rate",
    "value": "0.6% to 1.85% by difficulty"
  },
  {
    "label": "Related gear",
    "value": "Sun Armor, Pride clan, Escanor title line"
  },
  {
    "label": "Moves",
    "value": "M1, Z, X, C, V, F"
...
const moveset = [
  {
    "key": "M1",
    "description": "Basic weapon combo.",
    "videoSrc": "",
    "poster": ""
  },
  {
    "key": "Z",
    "description": "Cruel Sun: leap upward with brief safety frames and slam a fiery attack into the target.",
    "videoSrc": "",
    "poster": ""
  },
  {
    "key": "X",
    "description": "Divine Slash: forward slash with splash damage around the target.",
    "videoSrc": "",
    "poster": ""
  },
  {
    "key": "C",
    "description": "Crazy Prominence: large circular flame attack around nearby enemies.",
    "videoSrc": "",
    "poster": ""
  },
  {
    "key": "V",
    "description": "The One: cutscene finisher that forms a massive fireball and crushes the area.",
    "videoSrc": "",
    "poster": ""
  },
  {
    "key": "F",
    "description": "Flame burst finisher that burns nearby enemies over multiple seconds.",
    "videoSrc": "",
    "poster": ""
  }
];
    ...
    <div className="min-h-screen flex flex-col items-center justify-start pb-16 md:pb-24 border-l-2 md:border-l-4 border-r-2 md:border-r-4 border-[var(--accent-red)] mx-auto max-w-[1920px] shadow-[inset_0_0_40px_rgba(255,30,56,0.1)] md:shadow-[inset_0_0_80px_rgba(255,30,56,0.15)] relative font-sans bg-slate-950">
      ...
      <main className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10 block">
        ...
        <div className="text-sm text-gray-400 mb-6 font-mono opacity-80">
          ...
          <span className="mx-2">/</span>
          <span className="text-gray-300">Escanor</span>
        </div>
        ...
        <div className="mb-12 flex flex-col md:flex-row gap-8 items-start">
          <div className="flex-1">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl leading-relaxed border-l-4 border-[var(--accent-red)] pl-4 backdrop-blur-sm bg-black/20 py-2">
              Boss Rush weapon route with fire-heavy AoE moves, Pride synergy, and the matching Sun Armor grind on Sailor Island.
            </p>
