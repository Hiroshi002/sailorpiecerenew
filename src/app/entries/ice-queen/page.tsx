...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: `How to Get Ice Queen in Sailor Piece | ${siteConfig.name}`,
    description: "Ice Queen guide for Sailor Piece with obtainment steps, NPC location, materials, questline, mastery, and evolution path notes.",
    openGraph: {
      title: `How to Get Ice Queen in Sailor Piece | ${siteConfig.name}`,
      description: "Ice Queen guide for Sailor Piece with obtainment steps, NPC location, materials, questline, mastery, and evolution path notes.",
      url: `${siteConfig.url}`,
...
const moveset = [
  ...
  {
    "key": "Z",
    "description": "After several slashes, jump upward and deal area damage.",
    "videoSrc": "",
    "poster": ""
  },
  {
    "key": "X",
    "description": "Throw piercing ice shards forward in a line.",
    "videoSrc": "",
    "poster": ""
  },
  {
    "key": "C",
    "description": "Create a large ice blast in an area around the target zone.",
    "videoSrc": "",
    "poster": ""
  },
  {
    "key": "V",
    "description": "Trigger a cutscene attack in the forward direction.",
    "videoSrc": "",
    "poster": ""
  },
  {
    "key": "F",
    "description": "Summon a huge ice blizzard after completing mastery.",
    "videoSrc": "",
    "poster": ""
  }
];
    ...
    <div className="min-h-screen flex flex-col items-center justify-start pb-16 md:pb-24 border-l-2 md:border-l-4 border-r-2 md:border-r-4 border-[var(--accent-red)] mx-auto max-w-[1920px] shadow-[inset_0_0_40px_rgba(255,30,56,0.1)] md:shadow-[inset_0_0_80px_rgba(255,30,56,0.15)] relative font-sans bg-slate-950">
      ...
      <main className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10 block">
        ...
        <div className="text-sm text-gray-400 mb-6 font-mono opacity-80">
          ...
          <span className="mx-2">/</span>
          <span className="text-gray-300">Ice Queen</span>
        </div>
        ...
        <div className="mb-12 flex flex-col md:flex-row gap-8 items-start">
          <div className="flex-1">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl leading-relaxed border-l-4 border-[var(--accent-red)] pl-4 backdrop-blur-sm bg-black/20 py-2">
              Boss Island late-game sword built around the Ice Queen boss, Frost Empress title, and a full bundle of frost materials.
            </p>
