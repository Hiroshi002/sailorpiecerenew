...
export const metadata: Metadata = {
  title: "Sailor Piece Titles | Damage, Luck, Boss Titles",
  description: "Sailor Piece titles guide with damage titles, luck titles, boss titles, event titles, and the strongest title choices.",
};

const metaItems = [
  {
    "label": "Main groups",
    "value": "Damage, Lucky, Farming, Event, Exclusive"
  },
  {
    "label": "Equip route",
    "value": "Inventory &gt; Titles tab"
  },
  {
    "label": "Latest boss title",
    "value": "Demon Dweller"
  },
  {
    "label": "Top tracked title",
    "value": "Demon Dweller"
  }
];
...
const relatedPages = [
  ...
  },
  {
    ...
    "title": "Demon Dweller",
    "summary": "Crystal Defense boss-wave title with the highest raw damage line currently tracked on the wiki."
  }
];
        ...
        <div className="mb-12 flex flex-col md:flex-row gap-8 items-start">
          <div className="flex-1">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl leading-relaxed border-l-4 border-[var(--accent-red)] pl-4 backdrop-blur-sm bg-black/20 py-2">
              Damage, farming, event, and exclusive titles used to push your Sailor Piece build further.
            </p>
