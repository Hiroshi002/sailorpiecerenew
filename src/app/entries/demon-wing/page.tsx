...
export const metadata: Metadata = {
  title: "Demon Wing | Sailor Piece Crystal Defense Accessory",
  description: "Demon Wing Sailor Piece page with the Crystal Defense route, Punch Island location, 1 Crystal Key entry, and the estimated 100%-luck drop range.",
};

const metaItems = [
  {
    "label": "Mode",
    "value": "Crystal Defense"
  },
  {
    "label": "Drop source",
  ...
  {
    "label": "Estimated 100%-luck rate",
    "value": "About 0.060% to 0.080% from the shown checks"
  },
  {
    "label": "Shown wave 40 rate",
    "value": "0.653% at wave 40 and 819.8% luck"
  },
  {
    "label": "Entry cost",
    "value": "1 Crystal Key"
  ...
  {
    "label": "Base stats",
    "value": "125% Defense / 102% Damage / 15% Damage Reduction"
  },
  {
    "label": "E10 stats",
    "value": "175% Defense / 142% Damage / 35% Damage Reduction"
  }
];
...
const relatedPages = [
  ...
  },
  {
    ...
    "title": "Accessories",
    "summary": "Boss-drop and shop accessories with current stats, obtainment routes, and the accessory pieces players build around in late game, with Demon Wing currently leading the broad stat line."
  },
  {
    "href": "/entries/anti-magic/index",
    "title": "Anti Magic",
    "summary": "Asta-themed Crystal Defense sword that shares the same boss-wave drop loop, normalizes to about 0.048% to 0.064% on the estimated 100%-luck baseline, and also has a 5,000 Crystal Coin shop route."
  }
];
    ...
    <div className="min-h-screen flex flex-col items-center justify-start pb-16 md:pb-24 border-l-2 md:border-l-4 border-r-2 md:border-r-4 border-[var(--accent-red)] mx-auto max-w-[1920px] shadow-[inset_0_0_40px_rgba(255,30,56,0.1)] md:shadow-[inset_0_0_80px_rgba(255,30,56,0.15)] relative font-sans bg-slate-950">
      ...
      <main className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10 block">
        ...
        <div className="text-sm text-gray-400 mb-6 font-mono opacity-80">
          ...
          <span className="mx-2">/</span>
          <span className="text-gray-300">Demon Wing</span>
        </div>
        ...
        <div className="mb-12 flex flex-col md:flex-row gap-8 items-start">
          <div className="flex-1">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl leading-relaxed border-l-4 border-[var(--accent-red)] pl-4 backdrop-blur-sm bg-black/20 py-2">
              Crystal Defense boss-drop accessory on Punch Island, with confirmed base and E10 stats plus an estimated 100%-luck drop range from the published boss checks.
            </p>
