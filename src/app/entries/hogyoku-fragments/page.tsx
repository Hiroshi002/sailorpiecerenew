    ...
    <div className="min-h-screen flex flex-col items-center justify-start pb-16 md:pb-24 border-l-2 md:border-l-4 border-r-2 md:border-r-4 border-[var(--accent-red)] mx-auto max-w-[1920px] shadow-[inset_0_0_40px_rgba(255,30,56,0.1)] md:shadow-[inset_0_0_80px_rgba(255,30,56,0.15)] relative font-sans bg-slate-950">
      ...
      <main className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
        ...
        <div className="text-sm text-gray-400 mb-6 font-mono opacity-80">
          ...
          <span className="text-gray-300">Hogyoku Fragments</span>
        </div>
        ...
        <div className="mb-12">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl leading-relaxed border-l-4 border-[var(--accent-red)] pl-4 backdrop-blur-sm bg-black/20 py-2">
            Six hidden fragments used for the Hollow Island quest that unlocks Soul Society (Hogyoku route) and the late-game True Aizen route.
          </p>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            
                  <div className="bg-white/5 backdrop-blur-sm rounded-xl p-3 border border-white/10">
                    <div className="text-xs text-gray-400 mb-1">Total fragments</div>
                    <div className="text-sm font-semibold text-white">6</div>
                  </div>

                  <div className="bg-white/5 backdrop-blur-sm rounded-xl p-3 border border-white/10">
                    <div className="text-xs text-gray-400 mb-1">Quest NPC</div>
                    <div className="text-sm font-semibold text-white">Hogyoku Quest NPC</div>
                  </div>

                  <div className="bg-white/5 backdrop-blur-sm rounded-xl p-3 border border-white/10">
                    <div className="text-xs text-gray-400 mb-1">Quest start</div>
                    <div className="text-sm font-semibold text-white">Hollow Island</div>
                  </div>

                  <div className="bg-white/5 backdrop-blur-sm rounded-xl p-3 border border-white/10">
                    <div className="text-xs text-gray-400 mb-1">Level gate</div>
                    <div className="text-sm font-semibold text-white">Around level 8,500</div>
                  </div>

                  <div className="bg-white/5 backdrop-blur-sm rounded-xl p-3 border border-white/10">
                    <div className="text-xs text-gray-400 mb-1">Unlock reward</div>
                    <div className="text-sm font-semibold text-white">Soul Society (Hogyoku route) portal</div>
                  </div>
          </div>
        </div>
          ...
          <div className="mb-8 relative z-10">
            ...
            <ul className="space-y-6">
                ...
                <li className="flex items-start gap-4 text-gray-300 leading-relaxed text-lg">
                  ...
                  <span>The Hogyoku Fragment route starts from the Hogyoku Quest NPC on Hollow Island.</span>
                </li>

                <li className="flex items-start gap-4 text-gray-300 leading-relaxed text-lg">
                  <span className="text-blue-400 mt-1">•</span>
                  <span>Players need to be around level 8,500 before the Hogyoku Quest NPC will start the route.</span>
                </li>

                <li className="flex items-start gap-4 text-gray-300 leading-relaxed text-lg">
                  <span className="text-blue-400 mt-1">•</span>
                  <span>You need all 6 Hogyoku Fragments to unlock the Soul Society (Hogyoku route) portal.</span>
                </li>

                <li className="flex items-start gap-4 text-gray-300 leading-relaxed text-lg">
                  <span className="text-blue-400 mt-1">•</span>
                  <span>This route is one of the key gates behind the True Aizen or True Manipulator progression line, and players should collect the fragments in order.</span>
                </li>
            </ul>
          </div>
        </div>
